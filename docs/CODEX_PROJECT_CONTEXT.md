...
- 当前待总 Review 专项：`docs/LLM_DECISION_AND_LIFE_CONTINUITY_PLAN.md`。LIFE.0～13 技术施工和 Windows 安装版验收完成，Schema 64～71 已落地；生活连续性与日记自然度 Review 未完成，因此 LIFE v1 尚未冻结、KIG 不得开工。

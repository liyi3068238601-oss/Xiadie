...
EAP PR #1 已于 2026-07-22 合并，CDS ConstructionBaseline 固定为 `main@6b8aa47134f8a9a55131c73bb1148e6912421c4f`、Schema 60、冻结协议和后端 `937 passed, 1 warning`。CDS.0～13 已完成施工：Schema 61/62 建立统一决策账本与模型运行时，Schema 63 增加无正文反馈/校准审计；当前 9 个 DecisionKind 全部最高为 Shadow，EAP、CTX、Knowledge 与 MEM 的 application ownership 均未转移。CDS.10 的 8 条未独立评审叙事样本 accuracy 仅 50%，CDS.12 只有一个真实 Provider 且 DeepSeek 两模型配对一致率 50%，均不具备晋级证据资格。`specialty-adapter-contract-v1` 只预留 LIFE/KIG revision/hash 与候选契约；EAP adapter v1 保持不变，diagnostic v2 独立增加错误码和延迟。CDS.13 已提供受冻结上限约束的设置、无正文诊断和一键确定性回退，后端全量 `2304 passed, 1 warning`、前端 `47 passed`、Vite 189 modules。2026-07-26 最终独立 Review 为 0 P0/P1/P2，正式冻结 `cognitive-decision-v1`、`decision-kind-registry-v1`、Schema 63 与兼容矩阵。CDS PR #2 已合并为 `main@0d7a2d08dc07f123d016da26da117fa58f9a48a1`；LIFE.0 已据此锁定 ConstructionBaseline，新增 ADR-0060/0061、60 条纯合成固定场景和能力差距报告，不新增生产写路径或迁移。LIFE.0 内部验证为后端 `2310 passed, 1 warning`、前端 `47 passed`、Vite 189 modules、Electron/Windows frozen-backend smoke 通过；阶段独立 Review 依用户要求留待 LIFE 总体 Review。LIFE 首个必要迁移仍从 Schema 64 开始；KIG 仍须等待 LIFE 冻结。

...
该专项只执行第 9.B 节 EAP.R0～EAP.R6；EAP.A～EAP.J 是历史计划，不再代表当前完成度。Schema 48～55 不回写，收口从 Schema 56 开始；当前已完成 R0～R3，Schema 到 58，下一阶段为 R4。R3 只将真实来源推进到 shadow 裁决，尚未开放任何用户可见主动投递。

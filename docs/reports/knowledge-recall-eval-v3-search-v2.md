...
| 路径 | avg | P50 | P90 | P99 |
|---|---:|---:|---:|---:|
| 总耗时 | 23.711538 | 27.0 | 30.0 | 32.96 |
| 确定性跳过 | 0.0 | 0.0 | 0.0 | 0.0 |
| FTS/dense 检索 | 21.91425 | 25.001 | 27.4979 | 29.3576 |
| 策略查询 | 1.643577 | 2.4675 | 3.0087 | 3.61691 |
...
| case | 期望 | 实际 | 检索命中 |
|---|---|---|---|
| semantic_cleanup | retrieve/semantic_candidate | retrieve/entity_hit | 是 |

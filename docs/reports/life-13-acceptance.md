...
状态：技术验收完成，等待人工安装/休眠验收与 LIFE 总 Review；尚未冻结。
...
| Windows 可执行版本 | 首启、关窗托盘保活、崩溃子进程清理、重启通过 |
...
尚未自动化的人工门：实际运行安装向导后的退出/托盘交互、整机休眠与唤醒，以及用户对生活连续性和日记自然度的总体 Review。完成前不勾选 LIFE v1 冻结，也不启动 KIG 迁移。

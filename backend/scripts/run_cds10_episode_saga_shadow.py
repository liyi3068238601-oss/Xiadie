...
def build_report(fixture: dict) -> dict:
    ...
    return {
        ...
        "schema_version": schema_version, "stage_schema_baseline": 62,
...
def render_markdown(report: dict) -> str:
    ...
    return "\n".join([
        ...
        f"- CDS.10 阶段未新增迁移、表或列；阶段基线为 Schema {report['stage_schema_baseline']}，当前项目为 Schema {report['schema_version']}。",

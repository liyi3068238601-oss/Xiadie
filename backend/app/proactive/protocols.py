...
PROTOCOL_REGISTRY = {
    CONVERSATION_PRESENCE_V2: ProtocolDefinition(
        CONVERSATION_PRESENCE_V2, 2, ProtocolStatus.FROZEN, None,
        "Stable eight-value user_status contract; incompatible changes require v3.",
    ),
    USER_AFFECT_OBSERVATION_V1: ProtocolDefinition(
        USER_AFFECT_OBSERVATION_V1, 1, ProtocolStatus.FROZEN, _validate_user_affect,
    ...
    PROACTIVE_FEEDBACK_V1: ProtocolDefinition(
        PROACTIVE_FEEDBACK_V1, 1, ProtocolStatus.FROZEN, _validate_feedback,
